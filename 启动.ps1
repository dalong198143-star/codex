...
$LiteLLMProcess = Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$ScriptDir'; & 'C:\Users\ThinkBook\AppData\Roaming\Python\Python311\Scripts\litellm.exe' --config '$ScriptDir\litellm_config.yaml' --port 1235" -WindowStyle Minimized -PassThru
...
$ProxyProcess = Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$ScriptDir'; python -m src.server" -WindowStyle Minimized -PassThru
